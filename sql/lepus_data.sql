...
-- ----------------------------
INSERT INTO `admin_menu` VALUES ('3', 'MySQL Monitor', '1', '0', 'mysql', 'icon-dashboard', '0', '1', '3', '2014-02-25 19:57:29');
INSERT INTO `admin_menu` VALUES ('5', 'Permission System', '1', '0', 'rabc', 'icon-legal', '0', '1', '10', '2014-02-26 12:24:33');
INSERT INTO `admin_menu` VALUES ('6', 'Health Monitor', '2', '3', 'mysql/index', ' icon-list', '0', '1', '1', '2014-02-26 12:25:15');
INSERT INTO `admin_menu` VALUES ('8', 'Replication Monitor', '2', '3', 'mysql/replication', ' icon-list', '0', '1', '6', '2014-02-26 12:26:05');
INSERT INTO `admin_menu` VALUES ('9', 'Slowquery Analysis', '2', '3', 'mysql/slowquery', 'icon-list', '0', '1', '9', '2014-02-26 12:26:52');
...
INSERT INTO `admin_menu` VALUES ('19', 'AWR Report', '2', '3', 'mysql/awrreport', 'icon-list', '0', '1', '12', '2014-03-06 13:47:17');
...
INSERT INTO `admin_menu` VALUES ('22', 'OS Monitor', '1', '0', 'os', 'icon-dashboard', '0', '1', '8', '2014-03-24 15:33:42');
INSERT INTO `admin_menu` VALUES ('26', 'Disk', '2', '22', 'os/disk', 'icon-list', '0', '1', '4', '2014-03-24 17:46:29');
INSERT INTO `admin_menu` VALUES ('28', 'BigTable Analysis', '2', '3', 'mysql/bigtable', 'icon-list', '0', '1', '7', '2014-04-02 13:38:15');
INSERT INTO `admin_menu` VALUES ('29', 'Key Cache Monitor', '2', '3', 'mysql/key_cache', 'icon-list', '0', '1', '3', '2014-04-09 15:52:12');
INSERT INTO `admin_menu` VALUES ('30', 'InnoDB Monitor', '2', '3', 'mysql/innodb', 'icon-list', '0', '1', '4', '2014-04-09 15:54:47');
INSERT INTO `admin_menu` VALUES ('31', 'Resource Monitor', '2', '3', 'mysql/resource', 'icon-list', '0', '1', '2', '2014-04-10 13:23:06');
INSERT INTO `admin_menu` VALUES ('32', 'MongoDB', '2', '16', 'servers_mongodb/index', 'icon-list', '0', '1', '5', '2014-04-14 12:26:35');
INSERT INTO `admin_menu` VALUES ('33', 'MongoDB Monitor', '1', '0', 'mongodb', 'icon-dashboard', '0', '1', '5', '2014-04-14 14:15:52');
INSERT INTO `admin_menu` VALUES ('34', 'Health Montior', '2', '33', 'mongodb/index', 'icon-list', '0', '1', '1', '2014-04-14 14:17:23');
INSERT INTO `admin_menu` VALUES ('35', 'Indexes Monitor', '2', '33', 'mongodb/indexes', 'icon-list', '0', '1', '2', '2014-04-14 16:25:48');
INSERT INTO `admin_menu` VALUES ('36', 'Memory Monitor', '2', '33', 'mongodb/memory', 'icon-list', '0', '1', '3', '2014-04-14 16:26:50');
INSERT INTO `admin_menu` VALUES ('40', 'Oracle', '2', '16', 'servers_oracle/index', 'icon-list', '0', '1', '4', '2014-05-27 13:21:49');
INSERT INTO `admin_menu` VALUES ('43', 'Health Monitor', '2', '22', 'os/index', 'icon-list', '0', '1', '0', '2014-07-08 09:19:11');
INSERT INTO `admin_menu` VALUES ('44', 'Disk IO', '2', '22', 'os/disk_io', 'icon-list', '0', '1', '5', '2014-07-15 15:35:56');
...
INSERT INTO `admin_menu` VALUES ('48', 'Redis Monitor', '1', '0', 'redis', 'icon-dashboard', '0', '1', '6', '2014-09-02 12:36:41');
INSERT INTO `admin_menu` VALUES ('50', 'Health Monitor', '2', '48', 'redis/index', 'icon-list', '0', '1', '2', '2014-09-02 12:39:58');
INSERT INTO `admin_menu` VALUES ('51', 'Redis', '2', '16', 'servers_redis/index', 'icon-list', '0', '1', '6', '2014-09-09 17:15:41');
INSERT INTO `admin_menu` VALUES ('52', 'Memory Monitor', '2', '48', 'redis/memory', 'icon-list', '0', '1', '3', '2014-09-11 14:34:13');
INSERT INTO `admin_menu` VALUES ('54', 'Replication Monitor', '2', '48', 'redis/replication', 'icon-list', '0', '0', '5', '2014-09-11 14:37:12');
INSERT INTO `admin_menu` VALUES ('56', 'Oracle Monitor', '1', '0', 'oracle', 'icon-dashboard', '0', '1', '4', '2014-10-24 15:34:50');
INSERT INTO `admin_menu` VALUES ('57', 'Health Montior', '2', '56', 'oracle/index', 'icon-list', '0', '1', '1', '2014-10-24 15:35:47');
INSERT INTO `admin_menu` VALUES ('58', 'Tablespace Monitor', '2', '56', 'oracle/tablespace', 'icon-list', '0', '1', '2', '2014-10-24 15:37:19');
...
-- ----------------------------
INSERT INTO `admin_privilege` VALUES ('1', 'MySQL Health Monitor', '6', 'mysql/index', '1');
INSERT INTO `admin_privilege` VALUES ('3', 'MySQL Replication Monitor', '8', 'mysql/replication', '2');
INSERT INTO `admin_privilege` VALUES ('4', 'MySQLSlowQuery', '9', 'mysql/slowquery', '4');
...
INSERT INTO `admin_privilege` VALUES ('36', 'MySQLSlowQuery Detail', '9', 'mysql/slowquery_detail', '4');
INSERT INTO `admin_privilege` VALUES ('37', 'MySQL AWR Report', '19', 'mysql/awrreport', '5');
INSERT INTO `admin_privilege` VALUES ('38', 'MySQL Health Chart', '6', 'mysql/chart', '1');
INSERT INTO `admin_privilege` VALUES ('39', 'MySQL Replication Chart', '8', 'mysql/replication_chart', '2');
INSERT INTO `admin_privilege` VALUES ('40', 'Alarm View', '21', 'alarm/index', '8');
INSERT INTO `admin_privilege` VALUES ('41', 'OS Health View', '43', 'os/index', '100');
INSERT INTO `admin_privilege` VALUES ('44', 'OS Disk View', '26', 'os/disk', '100');
INSERT INTO `admin_privilege` VALUES ('46', 'OS Disk Chart View', '26', 'os/disk_chart', '100');
INSERT INTO `admin_privilege` VALUES ('48', 'OS Health Chart View', '43', 'os/chart', '100');
INSERT INTO `admin_privilege` VALUES ('49', 'MySQL BigTable Analysis', '28', 'mysql/bigtable', '8');
INSERT INTO `admin_privilege` VALUES ('50', 'MySQL BigTable Analysis Chart', '28', 'mysql/bigtable_chart', '8');
INSERT INTO `admin_privilege` VALUES ('51', 'MySQL Key Cache Monitor', '29', 'mysql/key_cache', '2');
INSERT INTO `admin_privilege` VALUES ('52', 'MySQL InnoDB Monitor', '30', 'mysql/innodb', '2');
INSERT INTO `admin_privilege` VALUES ('53', 'MySQL Resource Monitor', '31', 'mysql/resource', '2');
...
INSERT INTO `admin_privilege` VALUES ('59', 'MongoDB Health View', '34', 'mongodb/index', '10');
INSERT INTO `admin_privilege` VALUES ('60', 'MongoDB Indexes View', '35', 'mongodb/indexes', '11');
INSERT INTO `admin_privilege` VALUES ('61', 'MongoDB Memory View', '36', 'mongodb/memory', '12');
...
INSERT INTO `admin_privilege` VALUES ('76', 'Mongodb Health Chart View', '34', 'mongodb/chart', '13');
INSERT INTO `admin_privilege` VALUES ('77', 'OS Disk View', '44', 'os/disk_io', '100');
INSERT INTO `admin_privilege` VALUES ('78', 'OS Disk Chart View', '44', 'os/disk_io_chart', '100');
...
INSERT INTO `admin_privilege` VALUES ('92', 'Redis Health View', '50', 'redis/index', '19');
INSERT INTO `admin_privilege` VALUES ('93', 'Redis Health Chart View', '50', 'redis/chart', '20');
...
INSERT INTO `admin_privilege` VALUES ('100', 'Redis Memory View', '52', 'redis/memory', '21');
INSERT INTO `admin_privilege` VALUES ('101', 'Redis Memory Chart View', '52', 'redis/memory_chart', '21');
INSERT INTO `admin_privilege` VALUES ('104', 'Redis Replication View', '54', 'redis/replication', '23');
INSERT INTO `admin_privilege` VALUES ('105', 'Redis Replication Chart View', '54', 'redis/replication_chart', '23');
INSERT INTO `admin_privilege` VALUES ('110', 'Oracle Health Monitor', '57', 'oracle/index', '25');
INSERT INTO `admin_privilege` VALUES ('111', 'Oracle Health Chart', '57', 'oracle/chart', '26');
INSERT INTO `admin_privilege` VALUES ('112', 'Oracle Tablespace Monitor', '58', 'oracle/tablespace', '27');
...
-- ----------------------------
INSERT INTO `admin_user` VALUES ('1', 'admin', '6f493fbddf9107797f5044bb229ac6ee', 'Administrator', 'admin@mail.com', '', '0', '', '2015-01-06 15:17:22', '1', '2013-12-25 15:58:34');
INSERT INTO `admin_user` VALUES ('8', 'guest', 'e10adc3949ba59abbe56e057f20f883e', 'Guest', '', '', '0', '', '2015-01-06 16:55:14', '1', '2014-03-12 17:06:36');
...
INSERT INTO `lepus_status` VALUES ('lepus_version', '3.6.0');
INSERT INTO `lepus_status` VALUES ('lepus_checktime', '2015-01-06 17:10:58');
