    ...
    <PageContainer>
      ...
      <Row>
        ...
        <Col span={20}>
          ...
          <Alert type="info" message="支持MySQL/MariaDB/GreatSQL/TiDB/Doris/OceanBase/ClickHouse/Oracle/PostgreSQL/SQLServer/MongoDB/Redis数据库的数据查询/数据变更/结构变更，功能和权限请参阅官方文档。" banner closable />
        </Col>
      </Row>
